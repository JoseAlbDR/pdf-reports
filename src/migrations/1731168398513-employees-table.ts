...
export class EmployeesTable1731168398513 implements MigrationInterface {
  name = 'EmployeesTable1731168398513';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "employees" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "position" character varying NOT NULL, "start_date" date NOT NULL, "work_time" TIME NOT NULL, "hours_per_day" integer NOT NULL, "work_schedule" character varying NOT NULL, CONSTRAINT "PK_b9535a98350d5b26e7eb0c26af4" PRIMARY KEY ("id"))`,
    );
